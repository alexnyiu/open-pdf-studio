...
export {
  ...
  flushEditorDraftForCommit as flushPdfEditorDraftForCommit,
  adoptFinalTextLayoutDecision as adoptPdfEditorFinalTextLayout,
  setEditorDraftFlushHandler as setPdfEditorDraftFlushHandler,
