...
pub fn encode_rgba_to_png_base64(width: u32, height: u32, pixels: &[u8]) -> Result<String, String> {
    ...
    let buffer: ImageBuffer<Rgba<u8>, &[u8]> = ImageBuffer::from_raw(width, height, pixels)
